        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {teamData.map((member) => (
            <div
              key={member.id}
              data-aos="fade-up"
              className="card bg-base-100 shadow-md hover:shadow-xl transition duration-300 border border-gray-200 hover:border-green-400 hover:bg-base-300 rounded-lg"
            >
